...
console.log ("Json del carrito:" + productos[0].categoria);
...
function ArmarCarrito(codigo, cantidad) {
  ...
  function carrito (productoId){
      ...
      //mmmmm si le pongo a todos botonCarro como id me toma siempre el primero. como puedo hacer que tome el valor sin ponerle a todos nombres <>
  ...
  //sessionStorage.setItem('test', miCarro);
